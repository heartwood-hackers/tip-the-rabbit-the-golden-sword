...
func _ready():
  ...
  var _phu = EventBus.connect("player_health_updated", self, "_player_health_updated")
  var _plu = EventBus.connect("player_lives_updated", self, "_player_lives_updated")
...
func _player_health_updated(player, new_health, _old_health):
  if(player.player_number != player_number): return
  update_health(new_health)


func _player_lives_updated(player, new_lives, _old_lives):
  if(player.player_number != player_number): return
